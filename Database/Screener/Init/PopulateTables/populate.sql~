...
INSERT INTO Questions (question, assessmentId) VALUES ('In this assessment, you will select an image that you feel best fits a matrix of images', 4);
INSERT INTO Questions (question, assessmentId) VALUES ('Here you will listen to some audio clips. You will have to listen to the audio and repeat what you heard. Click Start to start this assessment.', 5);
INSERT INTO Questions (question, assessmentId) VALUES ('You will be provided with a letter. Please say as many words as you can starting with the letter. Click on Start Recording whenever you are ready. You will be given a 3 second countdown after which you can start saying the words.', 6);
